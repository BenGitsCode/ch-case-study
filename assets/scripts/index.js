...
let margin = {
  ...
  // data call;
  d3.json('http://api.population.io/1.0/population/2010/United%20States/', function (data){
    let headers = ["Female Population by Age in 2010"];

    var layers = d3.layout.stack()(headers.map(function() {
...
/////// TESTING TODO  below is original
